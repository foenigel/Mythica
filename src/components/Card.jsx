...
const Card = ({info, image, color}) => {
    ...
    return ( 
    <div className="relative flex max-w-[420px] w-full h-[400px] md:h-[500px] md:border-[3px] md:border-customLightGrayBorder md:p-6 md:items-start md:justify-center">
